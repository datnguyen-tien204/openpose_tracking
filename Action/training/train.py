...
# load data
raw_data = pd.read_csv(r'C:\Users\nguye\Downloads\Compressed\Online-Realtime-Action-Recognition-based-on-OpenPose-master\Online-Realtime-Action-Recognition-based-on-OpenPose-master\Action\training\data_under_scene.csv', header=0)
...
model.summary()
his.loss_plot('epoch')
model.save('framewise_recognition1.h5')
...
# test
model = load_model('framewise_recognition1.h5')
